...
class _HomeScreenState extends State<HomeScreen> {
  String previousNum=''; //prévia do número
  String currentNum=''; //número atual
  String result=''; //resultado
  String prev_result=""; //prévia resultado
  String selectedOperation=''; //Operação
